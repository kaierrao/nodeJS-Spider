...
let getNext = function(_csrf, op) {
  let syncUrl = 'https://www.cnbeta.com/comment/read';
  return new Promise(function(resolve, reject) {
    if (!_csrf || !op) {
      ...
      https.get(syncUrl, function(res) {
        let resChunk = '';
...
let fetchPage = function(x, fullpath) {
  ...
  let articalUrl = fullpath || `https://www.cnbeta.com/articles/${x}.htm`;
  let client = https.get(articalUrl, function(res) {
